#ifndef RM_MODEL_DATA_LOADER_H
#define RM_MODEL_DATA_LOADER_H
...
class MappedDataset {
 public:
  using U64Data = TrainingData<uint64_t>;
  using U32Data = TrainingData<uint32_t>;
  using F64Data = TrainingData<double>;
